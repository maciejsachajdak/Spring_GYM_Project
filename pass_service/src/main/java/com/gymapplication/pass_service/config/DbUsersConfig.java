...
@EnableJpaRepositories(
        ...
        basePackages = {"com.gymapplication.pass_service.repositoryDbUsers"},
        transactionManagerRef = "usersTransactionManager"
)
@EntityScan(basePackages = {"com.gymapplication.pass_service.entityDbUsers"})
public class DbUsersConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() {
        ...
        bean.setPackagesToScan("com.gymapplication.pass_service.entityDbUsers");
        return bean;
