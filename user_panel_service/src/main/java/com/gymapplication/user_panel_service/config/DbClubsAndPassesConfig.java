...
@EnableJpaRepositories(
        ...
        basePackages = {"com.gymapplication.user_panel_service.repositoryDbClubsAndPasses"},
        transactionManagerRef = "clubsAndPassesTransactionManager"
)
@EntityScan(basePackages = {"com.gymapplication.user_panel_service.entityDbClubsAndPasses"})
public class DbClubsAndPassesConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() {
        ...
        bean.setPackagesToScan("com.gymapplication.user_panel_service.entityDbClubsAndPasses");
        return bean;
